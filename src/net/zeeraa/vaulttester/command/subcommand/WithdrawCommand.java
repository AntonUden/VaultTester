...
public class WithdrawCommand extends ZSubCommand {

	public WithdrawCommand() {
		super("withdraw");
		setPermission("vaulttester.command.vaulttester.withdraw");
		setPermissionDefaultValue(PermissionDefault.OP);
		setAllowedSenders(AllowedSenders.ALL);
		setDescription("Withdraw amount from player");
		setHelpString("/vaulttester withdraw <Balance> [Player]" + ChatColor.AQUA + "Withdraw amount from player");
		addHelpSubCommand();
	}
	...
	public boolean execute(CommandSender sender, String commandLabel, String[] args) {
		...
		EconomyResponse res = econ.withdrawPlayer(player, amount);
